...
NVDB_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "data", "disney_cloud.nvdb")
...
transmittance_map = imp.RaymarchingTransmittanceNanoVDBDDA(
    nvdb_tensor, shape=(D, H, W), step_size=0.001, transform=transform,
